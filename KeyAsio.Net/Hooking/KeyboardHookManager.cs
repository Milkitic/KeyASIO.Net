...
public class KeyboardHookManager
{
    ...
    {
        return this.RegisterHotkey(Array.Empty<ModifierKeys>(), key, action);
    }
    ...
    public Guid RegisterHotkey(ModifierKeys modifiers, Keys key, Action<CallBackType> action)
    {
        ...
        return RegisterHotkey(selectedModifiers, key, action);
    }
    ...
    {
        this.UnregisterHotkey(new ModifierKeys[0], key);
    }
