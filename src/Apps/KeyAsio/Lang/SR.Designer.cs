...
namespace KeyAsio.Lang {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   查找类似 Prevents clipping when hitsounds stack. &apos;Soft&apos; mode is recommended; disable for raw audio. Note: &apos;Peak&apos; mode increases CPU usage. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Peak (Lookahead) 的本地化字符串。
        /// </summary>
        internal static string Audio_LimiterType_Peak {
            get {
                return ResourceManager.GetString("Audio_LimiterType_Peak", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Linear Pan 的本地化字符串。
        /// </summary>
        internal static string BalanceMode_LinearStereoPan {
            get {
                return ResourceManager.GetString("BalanceMode_LinearStereoPan", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 ProMix Focus 的本地化字符串。
        /// </summary>
        internal static string BalanceMode_ProMixFocus {
            get {
                return ResourceManager.GetString("BalanceMode_ProMixFocus", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Choose a stereo panning law. Equal-Power and Linear Stereo Pan are standard algorithms; ProMix Focus is KeyASIO&apos;s center-preserving sound-field effect. 的本地化字符串。
        /// </summary>
